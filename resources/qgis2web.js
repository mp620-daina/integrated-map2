...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        maxZoom: 24,
        minZoom: 11,
        extent: [489729.748021, 9251419.839502, 494593.496863, 9253650.023671],
        projection: new ol.proj.Projection({
            code: 'EPSG:32737',
            //extent: [489953.390366, 9248922.490219, 494282.813496, 9257350.765171],
            units: 'm'
        })
    })
});
...
map.getView().fit([489729.748021, 9251419.839502, 494593.496863, 9253650.023671], map.getSize());
